...
import { PointProps, emptyPoint, usePointShipmentStatus } from "../../../utils/points";
...
export default function Point({
	...
	const state = usePointShipmentStatus(point || emptyPoint);
	...
	return (
		<Form
			...
			className="w-full flex-col relative  gap-4 flex"
		>
